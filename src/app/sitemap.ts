...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/en`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    ...
    { url: `${SITE_URL}/insight/guide`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${SITE_URL}/whats-new`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
