...
describe("Phase B-A Day 13: Insight #40-#42 着地で 41/41 達成 + Week 1 Day 3 で #42 fuel-cost-decomp 追加", () => {
  test("INSIGHTS が 42 件に到達 (Week 1 Day 3 で fuel-cost-decomp 追加)", () => {
    expect(INSIGHTS).toHaveLength(42);
  });
