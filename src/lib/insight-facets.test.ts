...
describe("Phase C Day 1: insight-facets", () => {
  ...
  test("INSIGHT_RENDERER_MAP: 64 本全 slug がマップに含まれる (5/24 で #64 capacity-market-area-vs-power-mix を追加 = 容量市場エリア別 Insight)", () => {
    ...
    expect(INSIGHTS.length).toBe(64);
    expect(Object.keys(INSIGHT_RENDERER_MAP)).toHaveLength(64);
  });
