...
export const INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    lede: "EPRX 年次取りまとめより、需給調整市場 6 商品 (一次・二次①②・三次①②・複合) の年間平均落札単価を可視化。FY2024 は 2.67〜3.30 円/ΔkW・30分の狭い帯に収まったが、FY2025 通年は 1.15〜3.93 に拡大 — 不足率が最も高い一次調整力は上昇し、不足がほぼ解消した三次調整力②は急落。価格差は応動速度ではなく調達不足率に現れる",
  ...
  },
  {
    ...
    lede: "需給調整市場で唯一 5 年取れる長期系列・三次調整力② (FY2021 2.58 → FY2022 3.49 → FY2023 1.46 → FY2024 3.30 → FY2025 1.15 円/ΔkW・30分) と JEPX スポット価格・燃料価格の連動を年次粒度で可視化。EPRX 公表の相関係数は 0.80 → 0.70 → 0.37 と低下、燃料局面で連動し平時で乖離する構造を読み解く",
  ...
  },
  {
    ...
    lede: "EPRX 年次取りまとめより、需給調整市場の電源種別別 (揚水 / 蓄電池 / VPP) 平均落札単価を商品別に対比。三次調整力②は FY2024 の 揚水 0.72 / 蓄電池 109.43 / VPP 46.24 円/ΔkW・30分 という二極構造から、FY2025 は蓄電池 19.31 (−82%)・VPP 53.59 の逆転へ一変。調達不足率の劇的改善 (36.9%→2.1%) が高値局面を縮小させた。単価は volume-weighted でなく「約定時の単価水準」であり、市場全体の単価でも市場寄与でもない点を明示",
  ...
  },
  {
    ...
    lede: "脱石炭の裏側。電気に占める風力＋太陽光の割合はこの10年で、英国13%→39%・ドイツ20%→47%と急伸し、抜けた石炭をほぼ1対1で置き換えた。米中も伸ばす中、日本は7%(2018)→12%で最も出遅れ——とくに風力が1.4%とほぼ存在しない。",
