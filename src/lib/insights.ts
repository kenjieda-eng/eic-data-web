...
export const INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    lede: "EPRX 年次取りまとめより、需給調整市場 6 商品 (一次・二次①②・三次①②・複合) の年間平均落札単価を可視化。FY2024 は 2.67〜3.30 円/ΔkW・30分の狭い帯に収まったが、FY2025 通年は 1.15〜3.93 に拡大 — 唯一調達不足が残る一次調整力だけが上昇し、不足がほぼ解消した三次調整力②は急落。価格差は応動速度ではなく調達不足率に現れる",
